...
import { Star, Repeat, Video, Book, Headphones, Lock, Users, X, MessageCircle } from "lucide-react";
...
export default function Homepage() {
  ...
  const course = { title: "Python", section: "Section 1, Unit 3", topic: "Functions & Data Structures" };
                  ...
                  <>
                    ...
                    <Dialog open={showMatchModal} onOpenChange={setShowMatchModal}>
                      <DialogContent className="max-w-md bg-background">
                        <div className="flex items-center justify-between py-8">
                          ...
                          >
                            <MessageCircle className="h-16 w-16 text-primary scale-x-[-1]" strokeWidth={2} />
                          </button>
                        </div>
                    ...
                    <div className="flex justify-center gap-8 mb-6">
                      ...
                      <Button
                        size="icon"
                        variant="outline"
                        className="h-24 w-24 rounded-full border-4 hover:bg-primary/10 transition-colors"
                        onClick={() => handleAction("like")}
                      >
                        <MessageCircle className="h-20 w-20 text-primary" strokeWidth={2.5} />
                      </Button>
                    </div>
